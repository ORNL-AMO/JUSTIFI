...
import { IconDefinition, faBuilding, faChevronDown, faChevronRight, faCircleInfo, faDatabase, faFolder, faFolderOpen, faHome, faInbox, faIndustry, faMinusSquare, faPlusSquare, faQuestionCircle, faScrewdriverWrench, faTrophy, faWandMagicSparkles } from '@fortawesome/free-solid-svg-icons';
