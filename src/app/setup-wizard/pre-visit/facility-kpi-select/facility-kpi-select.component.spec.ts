...
import { FacilityKpiSelectComponent } from './facility-kpi-select.component';
...
describe('FacilityKpiSelectComponent', () => {
  ...
  let fixture: ComponentFixture<FacilityKpiSelectComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(FacilityKpiSelectComponent);
