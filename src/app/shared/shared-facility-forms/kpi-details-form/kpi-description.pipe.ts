...
const WasteDescription = `In manufacturing, waste is broadly defined as anything that does not add value to the final product from the customer's perspective. This can include excess materials, defects, overproduction, waiting time, unnecessary motion, transportation, inventory, and underutilized talent. Essentially, it encompasses any resource or process that doesn't contribute to the creation of a product or service that a customer is willing to pay for. This is often tracked as the physical waste of a company. Several kinds of costs are associated with physical waste: disposal, regulatory, rework, nonconforming product value, returns, and more. Energy projects can reduce waste by reducing by improving quality and reducing intermediate material needs.`;
...
const AirEnvironmentalQualityDescription = `Air quality is an indicator monitoring the presence of dust and particulate matter in a company's operations, as well as compliance with environmental air quality regulations. Energy projects can improve air quality metrics by reducing airborne particulates and helping maintain regulatory compliance.`;

const CustomerSatisfactionDescription = `Customer Satisfaction is an indicator measuring the success of a business's engagement with partners and the health of those relationships. While this may be difficult to measure, can be partially quantified using KPMs that measure the success of a business's engagement with partners, such as customer and supplier satisfaction ratings, customer churn, lost sales. Energy projects can improve customer satisfaction by increasing productivity, meeting organizational targets, or introducing new products.`;

const SalesGrowthDescription = `Sales Growth is an indicator of the revenue increase from selling manufactured goods over a specific period, typically a month, quarter, or year. It is a key indicator of a company's financial health and market performance, reflecting how well it is attracting customers and meeting demand. Energy projects have the potential to generate additional revenues by increasing productivity, introducing new products, or other product changes.`;