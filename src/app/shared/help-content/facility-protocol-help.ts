...
export const FacilityProtocolHelp = {
    ...
    efficiencyIncentives: `Check out the NLR Knowledge Library for Non-energy Benefits Funding Resources for potential funding sources. <a class="click-link" href="https://www.nrel.gov/manufacturing/non-energy-benefits" target="_blank">NEBs Knowledge Library</a>`,
