...
export const FacilityProtocolHelp = {
    ...
    financialMetricsUsed: `Tools or resources could include simple spreadsheets or larger software platforms. This can help assessors begin to identify what and how much data will be available for calculating cost savings and who to contact. This is just for keeping broad notes: there will be places to enter this specific data further into the tool.`,
    efficiencyIncentives: `Check out the NLR Knowledge Library for Multiple Benefits Funding Resources for potential funding sources. <a class="click-link" href="https://www.nrel.gov/manufacturing/non-energy-benefits" target="_blank">Multiple Benefits Knowledge Library</a>`,
    dependentFunding: `Understand where the facility's funding for energy projects comes from. Does the site have an energy project budget? Is there an operational budget to fund smaller projects? Can teams co-fund projects with each other? Are they aware and can utilize external funding opportunities? Have they ever used Energy as a Service (EaaS), PACE loans, or other external avenues?`
